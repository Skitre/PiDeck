...
export const en = {
  ...
  commandExtensionFloatNext: "Focus next Extension float",
  commandExtensionFloatPrevious: "Focus previous Extension float",
  commandExtensionMoveDock: "Move Extension surface to Extensions Dock",
  commandExtensionMoveFloat: "Move Extension surface to a floating panel",
  commandExtensionMoveAnchorAbove: "Move Extension surface above the composer",
  commandExtensionMoveAnchorBelow: "Move Extension surface below the composer",
  commandExtensionDockTabNext: "Next tab in the focused Extensions Dock group",
  commandExtensionDockTabPrevious: "Previous tab in the focused Extensions Dock group",
  commandExtensionDockMoveSecondary: "Move Extension surface to the Dock secondary group",
  commandExtensionDockMovePrimary: "Move Extension surface to the Dock primary group",
  commandExtensionDockResizeLarger: "Enlarge the Extensions Dock primary group",
  commandExtensionDockResizeSmaller: "Shrink the Extensions Dock primary group",
  commandExtensionResetFamily: "Reset the focused Extension family presentation",
  ...
  navExtensionUi: "Extension UI",
  extensionUiSettingsSubtitle: "Where Extension widgets, status, custom UI, and prompts appear",
  ...
  extensionUiSettingsGroup: "Extension UI",
  extensionUiSettingsEmpty:
    "After an Extension uses a widget, status, custom UI, or blocking request, its placement options appear here.",
  extensionUiShowIn: "Show in",
  extensionUiPin: "Pin",
  extensionUiFamilyWidget: "Widget",
  extensionUiFamilyStatus: "Status",
  extensionUiFamilyCustom: "Custom UI",
  extensionUiFamilyBlocking: "Blocking requests",
  extensionUiHomeFollowExtension: "Follow Extension",
  extensionUiHomeFollowHost: "Follow Host policy",
  extensionUiHomeAboveComposer: "Above composer",
  extensionUiHomeBelowComposer: "Below composer",
  extensionUiHomeDockPrimary: "Extensions Dock · primary",
  extensionUiHomeDockSecondary: "Extensions Dock · secondary",
  extensionUiHomeFloat: "Floating panel",
  ...
  extensionUiUndoAppliesToAllSessions: "Applies to all sessions",
  extensionUiUndo: "Undo",
  extensionUiMovedToDock: "{name} {family} now opens in Extensions Dock",
  extensionUiMovedToFloat: "{name} {family} now opens as a floating panel",
  extensionUiMovedToAnchorAbove: "{name} {family} now opens above the composer",
  extensionUiMovedToAnchorBelow: "{name} {family} now opens below the composer",
  extensionUiMovedToHidden: "{name} {family} is now hidden",
  extensionUiChangedHome: "{name} {family} presentation updated",
  extensionUiFloatLabel: "{name} {family}",
  extensionUiFloatClose: "Close {name} {family}",
  extensionUiFloatPin: "Pin {name} {family}",
  extensionUiFloatUnpin: "Unpin {name} {family}",
  extensionUiFloatResize: "Resize {name} {family}",
  extensionUiAnchorAbove: "Extension surfaces above composer",
  extensionUiAnchorBelow: "Extension surfaces below composer",
  extensionUiStatusAbove: "Extension status above composer",
  extensionUiDockArea: "Extensions Dock",
  extensionUiDockDrop: "Drop here to dock",
